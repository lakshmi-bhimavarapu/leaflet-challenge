...
// Create a third layer (for the challenge)
  ...
  function getRadius(magnitude) {
    ...
    style: styleInfo,
     ...
     onEachFeature: function(feature, layer) {
      layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place + "<br>Depth(kms): " + feature.geometry.coordinates[2]);
    }
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getMajorColor(feature.geometry.coordinates[2]),
      color: "#000000",
      radius: getRadius(feature.properties.mag),
      stroke: true,
      weight: 0.5
  ...
  L.geoJson(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place  + feature.properties.place + "<br>Depth(kms): " + feature.geometry.coordinates[2]);
    }
...
let legend = L.control({
  ...
  // Looping through our intervals to generate a label with a colored square for each interval.
    ...
    let myStyle = {
      ...
      // Adding Tectonic Plate geoJSON data.
